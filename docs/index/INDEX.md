...
| 2 | [FitSci - Evaluator context.md](../other/FitSci%20-%20Evaluator%20context.md) | 5 min | Product context — the problem, the solution, target audience |
| 3 | [FitSci - Stack Analysis.md](../stack/FitSci%20-%20Stack%20Analysis.md) | 4 min | Why FastAPI + React + PostgreSQL (and why **not** Streamlit / LangChain / RAG) |
| 4 | [FitSci - Technical Architecture.md](../architecture/FitSci%20-%20Technical%20Architecture.md) | 4 min | Hexagonal vs Layered vs Modular Monolith — and why hexagonal won |
| 5 | [FitSci - Directory Structure.md](../architecture/FitSci%20-%20Directory%20Structure.md) | 6 min | Where each port and adapter lives (target structure with phase markers) |
| 6 | [FitSci - Development Plan.md](../architecture/FitSci%20-%20Development%20Plan.md) | 15 min | Master roadmap — Phase 0–4, measurable DoDs, time-boxes, risks |
| 7 | [FitSci - Cross-Cutting Concerns.md](../architecture/FitSci%20-%20Cross-Cutting%20Concerns.md) | 10 min | Logging, errors, caching, prompt-injection, secrets, CI — the unglamorous essentials |
| 8 | [FitSci - Risk Register.md](../other/FitSci%20-%20Risk%20Register.md) | 6 min | Top-5 risks with mitigations + the full register |
| 9 | [FitSci - Research Evaluation Model.md](../other/FitSci%20-%20Research%20Evaluation%20Model.md) | 6 min | Scoring science — v1 (what runs) vs v2 (target) |
| 10 | [scoring_basis.md](../other/scoring_basis.md) | 3 min | Canonical v1 scoring rules — the source of truth for what `scoring.py` does |
| 11 | [FitSci - Design.md](../design/FitSci%20-%20Design.md) | 4 min | Bio-Signal aesthetic, color tokens, component architecture |
...
## 2. Documents in `docs/` (subject-specific subdirectories)

> Documents are organized into directories depending on their subject (architecture, stack, design, index, other).

| Document | What it answers | Status |
|---|---|---|
| [INDEX.md](./INDEX.md) (this file) | Where do I find anything? | Active |
| [FitSci - Evaluator context.md](../other/FitSci%20-%20Evaluator%20context.md) | What is this project, for whom, and why? | Active |
| [FitSci - Development Plan.md](../architecture/FitSci%20-%20Development%20Plan.md) | What ships in which phase, with what acceptance criteria? | Active — v2.0 (post-audit) |
| [FitSci - Technical Architecture.md](../architecture/FitSci%20-%20Technical%20Architecture.md) | What architectural pattern do we follow and why? | Active — Option A locked |
| [FitSci - Directory Structure.md](../architecture/FitSci%20-%20Directory%20Structure.md) | Where does each module live in the codebase? | Active — target structure with phase markers |
| [FitSci - Stack Analysis.md](../stack/FitSci%20-%20Stack%20Analysis.md) | What stack did we pick, what did we reject, why? | Active — verdict locked |
| [FitSci - Research Evaluation Model.md](../other/FitSci%20-%20Research%20Evaluation%20Model.md) | What scientific scoring model do we aspire to (v2) and why? | Active — v2 conceptual target |
| [scoring_basis.md](../other/scoring_basis.md) | What scoring rules does the code actually run today (v1)? | **Canonical for code** |
| [FitSci - Design.md](../design/FitSci%20-%20Design.md) | Bio-Signal UI aesthetic, palette, components | Active |
| [FitSci - Cross-Cutting Concerns.md](../architecture/FitSci%20-%20Cross-Cutting%20Concerns.md) | Logging, errors, caching, prompt-injection, secrets, CI | Active — v1.0 |
| [FitSci - Risk Register.md](../other/FitSci%20-%20Risk%20Register.md) | What can go wrong, scored, with mitigations and owners | Active — v1.0 |
| [FitSci - Message Broker Implementation Plan.md](../architecture/FitSci%20-%20Message%20Broker%20Implementation%20Plan.md) | How RabbitMQ will decouple evaluation from the API | Planned |

### Phase Summaries

| Document | Purpose | Status |
|---|---|---|
| [phase_1_summary.md](../other/phase_1_summary.md) | The Core "Scientist" MVP Phase 1 Summary & Walkthrough | ✅ Complete |
| [tutorial.md](../other/tutorial.md) | User Testing Walkthrough | ✅ Complete |
...
## 4. Internal Audit Reports (`docs/audit/`)
...
|---|---|---|
| **Project pitch** | [README.md](../../README.md) | [Evaluator context.md](../other/FitSci%20-%20Evaluator%20context.md) |
| **Why hexagonal?** | [ADR-0001](../adr/0001-architecture-hexagonal.md) | [Technical Architecture.md](../architecture/FitSci%20-%20Technical%20Architecture.md), [audit-architecture.md](../audit/before-phase-0/audit-architecture.md) |
| **Where does file X live?** | [Directory Structure.md](../architecture/FitSci%20-%20Directory%20Structure.md) | — |
| **What ships in Phase N?** | [Development Plan.md](../architecture/FitSci%20-%20Development%20Plan.md) | [Risk Register.md](../other/FitSci%20-%20Risk%20Register.md), [Cross-Cutting Concerns.md](../architecture/FitSci%20-%20Cross-Cutting%20Concerns.md) |
| **What does the Judge actually compute?** | [scoring_basis.md](../other/scoring_basis.md) | [Research Evaluation Model.md](../other/FitSci%20-%20Research%20Evaluation%20Model.md), [ADR-0002](../adr/0002-scoring-canonical-spec.md) |
...
| **Future Gemma features (post-hackathon)** | [audit-gemma4-features.md](../audit/before-phase-0/audit-gemma4-features.md) | [Development Plan.md §4 Phase 4](../architecture/FitSci%20-%20Development%20Plan.md) |
| **Fine-tuning pipeline (post-hackathon)** | [audit-finetuning-pipeline.md](../audit/before-phase-0/audit-finetuning-pipeline.md) | [Development Plan.md §4 Phase 4](../architecture/Development%20Plan.md) |
| **Logging / error / cache / metrics ports** | [Cross-Cutting Concerns.md](../architecture/FitSci%20-%20Cross-Cutting%20Concerns.md) | [Directory Structure.md](../architecture/FitSci%20-%20Directory%20Structure.md) |
| **Prompt-injection defense** | [Cross-Cutting Concerns.md §6](../architecture/FitSci%20-%20Cross-Cutting%20Concerns.md) | [Risk Register.md R4](../other/FitSci%20-%20Risk%20Register.md) |
...
* **Pre-commit / CI guards** (Phase 0):
  * Any change to `backend/src/domain/services/scoring.py` must touch `docs/other/scoring_basis.md` in the same commit ([ADR-0002](../adr/0002-scoring-canonical-spec.md)).
  * Any change to a `domain/ports/*` Protocol should touch [Directory Structure.md](../architecture/FitSci%20-%20Directory%20Structure.md) or be accompanied by a new ADR.
...
*If you reached here from somewhere unexpected, the canonical pointer to this index is `docs/index/INDEX.md` from the repo root, or "[Quick links](../../README.md#quick-links)" in the README.*
